  ...
  <section className={`${styles.yPaddings} sm:pl-16 pl-6`}>
    ...
    >
      <div className="flex justify-center items-center flex-col relative z-10">
        ...
        >
          <h1 className="font-bold lg:text-[144px] md:text-[100px] sm:text-[60px] text-[44px] lg:leading-[158.4px] md:leading-[114.4px] sm:leading-[74.4px] leading-[64.4px] uppercase text-white">Deck</h1>
        </motion.div>
      </div>
